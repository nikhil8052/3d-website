...
Command: npx gltfjsx@6.5.3 public/models/workwithimg.glb 
*/
...
export function Model(props) {
  ...
  const { nodes, materials, animations } = useGLTF('/workwithimg.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <mesh name="phone_descriptor_title_text001" geometry={nodes.phone_descriptor_title_text001.geometry} material={materials.Material} position={[-138.07, 387.251, 0.029]} rotation={[-Math.PI, 0, 0]} scale={[-0.491, -0.712, -0.98]} />
...
useGLTF.preload('/workwithimg.glb')
