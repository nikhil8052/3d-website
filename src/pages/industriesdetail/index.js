...
import ImageTextCol from "@/pages/components/ImageTextCol";
...
import MarqueText from "@/pages/components/MarqueText";
  ...
  return (
    <>
      <HeroBanner
        ...
        subtitle="We are medical care web composition specialists!"
        description="Nisl hac elementum vulputate euismod libero phasellus iaculis ridiculus gravida. Nascetur euismod metus praesent adipiscing primis justo habitasse rutrum penatibus. Curae sed praesent habitant volutpat suspendisse. Habitasse scelerisque consectetur platea viverra penatibus. Felis et nisl in ultricies scelerisque mi. Rhoncus varius suspendisse euismod senectus fames pretium adipiscing? Malesuada pellentesque amet metus iaculis justo donec dictum mattis. Tempor habitant penatibus vehicula; fusce dui conubia auctor. Aliquet faucibus tincidunt sit potenti sit suscipit viverra nostra commodo aliquam pretium."
        ctaText="Tell Us About You Project"
        ctaLink="/contact"
        additionalText=""
        currentpage="industriesdetail"
      />
       <MarqueText text="Product Architecture - Product Architecture - Product Architecture - " />
       <ImageTextCol 
    imageUrl="/img/i1.png"
    subtitle="Each medical care association has various items, administrations, interest groups, and objectives."
    description="Nisl hac elementum vulputate euismod libero phasellus iaculis ridiculus gravida. Nascetur euismod metus praesent adipiscing primis justo habitasse rutrum penatibus. Curae sed praesent habitant volutpat suspendisse. Habitasse scelerisque consectetur platea viverra penatibus. Felis et nisl in ultricies scelerisque mi. Rhoncus varius suspendisse euismod senectus fames pretium adipiscing? Malesuada pellentesque amet metus iaculis justo donec dictum mattis. Tempor habitant penatibus vehicula; fusce dui conubia auctor. Aliquet faucibus tincidunt sit potenti sit suscipit viverra nostra commodo aliquam pretium."
    disheading="First Impressions Count:"
    distext="Lorem ipsum odor amet, consectetuer adipiscing elit. Sit viverra quisque curabitur risus faucibus cursus scelerisque."
    features={[
...
/>
      <MarqueText text="Research Stage ‘ -  Research Stage ‘ -  Research Stage ‘ -  Research Stage ‘ - " />
      <ImageTextCol 
    imageUrl="/img/i2.png"
    subtitle="With regards to medical care web composition, the examination stage is basic."
    description="Nisl hac elementum vulputate euismod libero phasellus iaculis ridiculus gravida. Nascetur euismod metus praesent adipiscing primis justo habitasse rutrum penatibus. Curae sed praesent habitant volutpat suspendisse. Habitasse scelerisque consectetur platea viverra penatibus. Felis et nisl in ultricies scelerisque mi. Rhoncus varius suspendisse euismod senectus fames pretium adipiscing? Malesuada pellentesque amet metus iaculis justo donec dictum mattis. Tempor habitant penatibus vehicula; fusce dui conubia auctor. Aliquet faucibus tincidunt sit potenti sit suscipit viverra nostra commodo aliquam pretium."
    // disheading="First Impressions Count:"
    // distext="Lorem ipsum odor amet, consectetuer adipiscing elit. Sit viverra quisque curabitur risus faucibus cursus scelerisque."
    features={[
        ["Aircraft system design", "Aerospace-grade hardware development"], // First column
        ["Safety-critical software solutions", ],     // Second column
    ]}
/>
      {/* <AboutSlider /> */}
      <WeWork />
