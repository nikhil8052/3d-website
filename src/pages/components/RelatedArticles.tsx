...
/>
             ...
             <div className="inner-div d-flex  mt-4 justify-content-between align-items-center">
             ...
             <div className="inner-div d-flex justify-content-between align-items-center bl">
...
/>
 ...
 <div className="More text-center mt-50">
