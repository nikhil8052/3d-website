...
Command: npx gltfjsx@6.5.3 public/models/liveday10.glb 
*/
...
export function Office(props) {
  ...
  const { nodes, materials, animations } = useGLTF('./models/liveday10.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
            ...
            <group name="Object_2">
              <group name="RootNode">
                ...
                <group name="pac_man_machine" rotation={[-Math.PI / 2, 0, 0]}>
                  <mesh name="pac_man_machine_automat_0" geometry={nodes.pac_man_machine_automat_0.geometry} material={materials.automat} scale={[0.627, 1, 0.828]} />
                </group>
        ...
        <group name="Sketchfab_model002" position={[15844.34, 89.114, -459.624]} rotation={[-Math.PI / 2, 0, 0]} scale={[113.37, 109.41, 172.61]}>
          <group name="28180fb1ec9a44a1b6262a52a443f630fbx001" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
            <group name="RootNode002">
              <group name="Mesh_FlagPole1001" position={[0, 1.329, 0]}>
                <mesh name="Mesh_FlagPole1_Mat_Flag_0001" geometry={nodes.Mesh_FlagPole1_Mat_Flag_0001.geometry} material={materials['Mat_Flag.001']} scale={[1.259, 1, 1]} />
                <mesh name="Mesh_FlagPole1_Mat_FlagPole_0001" geometry={nodes.Mesh_FlagPole1_Mat_FlagPole_0001.geometry} material={materials['Mat_FlagPole.001']} />
              </group>
            </group>
          </group>
        </group>
        ...
        <mesh name="crown_sugn_our_service"  position={[12005.32, 385.325, 0.25]} scale={[1.52, 1.202, 39.55]} >
        <Html>
        ...
        <mesh name="hello_sign_contact"  position={[17046.404, 398.64, 14.091]} >
        <Html>
              <div className='about-wall about-wall-text'
                style={{
                  width: '40rem',
        ...
        <mesh name="portfolio_text_03" geometry={nodes.portfolio_text_03.geometry} material={nodes.portfolio_text_03.material} position={[7858.798, 287.038, -0.29]} >
        <Html>
            <div className='about-wall work-wall-text work-txt-wal'
              style={{
                width: '40rem',
        ...
        <mesh name="Text_Var_02001" geometry={nodes.Text_Var_02001.geometry} material={materials.Tex_03} position={[-27.143, 144.109, -6.303]} scale={[101.756, 115.179, 325.173]} />
        <mesh name="portfolio_text_01003" geometry={nodes.portfolio_text_01003.geometry} material={materials['Material.001']} position={[4871.403, 263.126, -474.467]} scale={[1.525, 1.576, 1.525]} />
        <mesh name="portfolio_text_06003" geometry={nodes.portfolio_text_06003.geometry} material={materials['Material.015']} position={[11313.888, 316.446, -534.96]} scale={[1.752, 0.491, 1]} />
...
useGLTF.preload('./models/liveday10.glb')
