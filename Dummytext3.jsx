...
export function Model(props) {
  ...
  const { nodes, materials, animations } = useGLTF('/dummytext3.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <mesh name="phone_descriptor_title_text001" geometry={nodes.phone_descriptor_title_text001.geometry} material={materials.Material} position={[-178.339, 396.942, 0.029]} rotation={[-Math.PI, 0, 3.09]} scale={[-0.625, -1.025, -0.98]} />
...
useGLTF.preload('/dummytext3.glb')
