...
Command: npx gltfjsx@6.5.3 public/models/testwow.glb 
*/
...
export function Model(props) {
  ...
  const { nodes, materials, animations } = useGLTF('/testwow.glb')
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <group name="Node0" position={[-174.103, 416.283, 12.482]} rotation={[1.435, 0, 0]}>
          <mesh name="Node1" geometry={nodes.Node1.geometry} material={materials.x1} position={[23.027, 99.999, -2.23]} />
          <mesh name="Node2" geometry={nodes.Node2.geometry} material={materials.x1} position={[-74.891, -0.286, -0.032]} />
        </group>
        <group name="Node0001">
          <mesh name="Node1001" geometry={nodes.Node1001.geometry} material={materials['x1.001']} />
          <mesh name="Node2001" geometry={nodes.Node2001.geometry} material={materials['x1.001']} />
        </group>
